...
<?php post_thumbnail_html('main-post-thumb', 'post_thumbnail', 'post_thumbnail', $post_thumbnail, _t("إضافة صورة"), $post_id ?? $info_id); ?>
<div class="form-group" id="post_content">
	<label class="font-weight-bold"><?php echo _t("محتوى المقال"); ?></label>
